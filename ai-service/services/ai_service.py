...
RESPONSE_TEMPLATES = {
    ...
    "mai-IN": {
        "found":   lambda count, names, _: f"अहाँक लेल {count} योजना भेटल: {names}। की अहाँ एहि मे सँ कोनो के बारे मे आओर जानऽ चाहैत छी?",
        "noMatch": lambda: "अहाँक प्रश्न लेल कोनो योजना नहि भेटल। शिक्षा, स्वास्थ्य, किसान वा घर के बारे मे पूछू।",
    },
    "bho-IN": {
        "found":   lambda count, names, _: f"रउवा खातिर {count} योजना मिलल: {names}। का रउवा इनहन में से कवनो के बारे में आउर जाने के बा?",
        "noMatch": lambda: "रउवा के सवाल खातिर कवनो योजना नईखे मिलल। शिक्षा, स्वास्थ्य, किसान चाहे घर के बारे में पूछीं।",
    },
}
